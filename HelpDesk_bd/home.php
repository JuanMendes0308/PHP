  ...
  <div class="container">
    <div class="row">
      ...
      <div class="card-home">
        <div class="card">
          ...
          <div class="card-body">
            <div class="row">
              ...
              <?php if ($row->perfil != 'Adm' && $row->perfil != 'Tec') { ?>
                <div class="col-2 d-flex justify-content-center">
                  <a href="#" style="filter: grayscale(100%); opacity: 0.5;">
                    <img src="editar-arquivo.png" width="70" height="70">
                    <p>&nbspEditar</p>
                  </a>
                </div>
                ...
                <div class="col-2 d-flex justify-content-center">
                <a href="#" style="filter: grayscale(100%); opacity: 0.5;">
                  <img src="autorizacao.png" width="70" height="70">
                  <p>Autorizar</p>
                </a>
              </div>
              ...
              <div class="col-2 d-flex justify-content-center">
                <a href="#" style="filter: grayscale(100%); opacity: 0.5;">
                  <img src="usuarios.png" width="70" height="70">
                  <p>&nbspUsuários</p>
                </a>
              </div>
        ...
        <div class="card-home">
          <div class="card">
            <img src="helpdesk.svg" alt="Banner" height="230px">
